...
, http-media, http-types, network, network-uri, QuickCheck, safe
...
mkDerivation {
  ...
  version = "0.2.2";
  src = /home/shana/programming/servant-client;
  buildDepends = [
  ...
  testDepends = [
    ...
    http-types network QuickCheck servant servant-server text wai warp
  ];
