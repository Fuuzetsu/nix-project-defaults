...
let
  inherit (haskellPackages) cabal aeson bifunctors comonad
    contravariant deepseq distributive doctest exceptions filepath
    genericDeriving hashable hlint HUnit mtl nats parallel primitive
    profunctors QuickCheck reflection scientific semigroupoids semigroups
    simpleReflect split tagged testFramework testFrameworkHunit
