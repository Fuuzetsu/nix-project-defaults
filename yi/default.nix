...
{ cabal, binary, Cabal, cautiousFile, concreteTyperep
, dataDefault, derive, dlist, dyre, filepath, fingertree
...
cabal.mkDerivation (self: {
  ...
  isExecutable = true;
  buildDepends = [
    binary Cabal cautiousFile concreteTyperep dataDefault derive
