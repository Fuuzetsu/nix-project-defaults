...
, QuickCheck, saltine, snapCore, snapServer, testFramework
, testFrameworkQuickcheck2, time, transformers
}:
...
cabal.mkDerivation (self: {
  ...
  isExecutable = true;
  buildDepends = [
    attoparsec binary cpu Crypto MonadRandom network QuickCheck saltine
    snapCore snapServer time transformers
  ];
  testDepends = [
